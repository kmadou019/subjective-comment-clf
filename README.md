Sure, here is the complete documentation in a single Markdown file:
...
This single Markdown file contains all the sections and content from both HTML pages. You can save this content into a `.md` file and use it as needed.